...
st.set_page_config(page_title="World Food Production — Classic layout",
                   page_icon="🌍", layout="wide")

# URL of the redesigned ("new") version, shown as a cross-link below.
NEW_APP_URL = "https://agenticaipractise-tbqheenguqz7cwbxdps6vf.streamlit.app/"
...
def main() -> None:
    ...
    st.info(
        f"📦 **Classic layout** (the original single-scroll version). "
        f"See the redesigned, tabbed version → [open the new UI]({NEW_APP_URL})",
        icon="🕰️",
    )
